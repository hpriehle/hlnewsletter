...
import sty from "./PlasmicPageLayout.module.css"; // plasmic-import: K2s2kMwDgXw5/css

import IconIcon from "./icons/PlasmicIcon__Icon"; // plasmic-import: EREPOSAXgrkR/icon
import Icon2Icon from "./icons/PlasmicIcon__Icon2"; // plasmic-import: GgCiCJA90Bqt/icon
...
function PlasmicPageLayout__RenderFunc(props: {
  ...
  return (
    <RichLayout
      ...
      logoElement={
        <Icon2Icon
          className={classNames(projectcss.all, sty.svg__p8Vjx)}
          role={"img"}
        />
      }
      navMenuItems={(() => {
    ...
    >
      <LoadingBoundary
        ...
        loadingState={
          <DataCtxReader__>
            {$ctx => (
              <div className={classNames(projectcss.all, sty.freeBox__yNvqe)}>
                <IconIcon
                  className={classNames(projectcss.all, sty.svg__xiePg)}
                  role={"img"}
                />
              </div>
            )}
      ...
      >
        <DataCtxReader__>
          {$ctx => (
            <div className={classNames(projectcss.all, sty.freeBox__gyLNr)}>
              {renderPlasmicSlot({
                defaultContents: (
                  <section
                    className={classNames(projectcss.all, sty.section__xArmn)}
                  >
                    <h1
                      className={classNames(
                        projectcss.all,
